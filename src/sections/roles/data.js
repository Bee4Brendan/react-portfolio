...
const data = [
    ...
    {
        id: 2, icon: <SiXaml/>, title: 'Frontend Development', desc: "UCO + Long Wave Inc. + Dudley - Designed and recreated frontend for Android applications and WPF in XAML. Created and updated components in ReactJS and TypeScript."
    },
    {
        id: 3, icon: <FaServer/>, title: 'Backend Development', desc: "UCO + Long Wave Inc. + Tinker AFB + Dudley - Implemented logic for every application participated in. Created databases in SQL for class. Used a lot of C++, C# (Entity Framework), and Java."
    },
    {
