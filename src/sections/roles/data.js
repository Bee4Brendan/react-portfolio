...
const data = [
    {
        id: 1, icon: <AiFillAppstore/>, title: 'Application Development', desc: "Long Wave Inc. - Developed a flight simulator for training Boeing E-6B Mercury pilots. This was for Windows, in C# .NET. & WPF. The simulator included an entire Operating System rebuild."
    },
    {
    ...
    {
        id: 4, icon: <BsAndroid2/>, title: 'Mobile App Development', desc: 'UCO - Designed many Java aplications for Android, including a dungeon crawler and Doodle Jump recreation.'
    }
]
