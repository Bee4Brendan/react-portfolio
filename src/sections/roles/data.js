...
const data = [
    ...
    {
        id: 3, icon: <FaServer/>, title: 'Backend Development', desc: "UCO + Long Wave Inc. + Tinker AFB - Implemented logic for every application participated in. Created databases in SQL for class."
    },
    {
